<?php
    ...
    include(__DIR__ . '/../conn_port/tt_port.php');
    ...
    $sql = "SELECT class_order, class_1, class_1_name, class_2, class_2_name, class_3, class_3_name, class_4,
            class_4_name, class_5, class_5_name FROM lab_1_tt";
    ...
    if ($res && mysqli_num_rows($res) > 0) {
        ...
        echo '<h2 style="width:100%; color:white; text-align:center">No Class available in the timetable.</h2>';
    }
