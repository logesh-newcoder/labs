<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!empty($_FILES['file']['name']) && isset($_POST['table'])) {
            ...
            if (strtolower($fileExtension) === 'csv') {
                if (is_uploaded_file($_FILES['file']['tmp_name'])) {
                    ...
                    if ($inserted) {
                        ...
                        echo "<script>
                                alert('Some records were not inserted. Please check your data.');
                                location.href = '../../htmlcodesheet/classtable.html'; 
                              </script>";
                    } else {
                        echo "<script>
                                alert('No records found to insert or update.');
                                location.href = '../../htmlcodesheet/classtable.html'; 
                              </script>";
                    }
            ...
            echo "<script>
                    alert('No file uploaded or no table selected.');
                    location.href = '../../htmlcodesheet/classtable.html'; 
                  </script>";
        }
    }
    ...
    if (isset($_POST['truncate'])) {
        ...
        if (isset($_POST['table'])) {
            ...
            if (mysqli_query($conn, $truncateQuery)) {
                echo "<script>
                        alert('Table data removed successfully');
                        location.href = '../../htmlcodesheet/classtable.html'; 
                      </script>";
            } else {
                echo "<script>
                        alert('Failed to remove table data');
                        location.href = '../../htmlcodesheet/classtable.html'; 
                      </script>";
            }
        } else {
            echo "<script>
                    alert('No table selected for truncation.');
                    location.href = '../../htmlcodesheet/classtable.html'; 
                  </script>";
        }
    }
